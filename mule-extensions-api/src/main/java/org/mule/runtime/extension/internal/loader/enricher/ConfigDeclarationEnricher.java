...
import static org.mule.runtime.extension.api.util.XmlModelUtils.MULE_DYNAMIC_CONFIG_POLICY_TYPE_QNAME;
 ...
 * @since 1.0
 */
public final class ConfigDeclarationEnricher extends InfrastructureDeclarationEnricher {
  ...
  public void enrich(ExtensionLoadingContext extensionLoadingContext) {
    new IdempotentDeclarationWalker() {
      ...
      protected void onConfiguration(ConfigurationDeclaration declaration) {
        addDynamicConfigPolicy(declaration);
      }
    }.walk(extensionLoadingContext.getExtensionDeclarer().getDeclaration());
  }

  protected void addDynamicConfigPolicy(ParameterizedDeclaration declaration) {
    ParameterDeclaration parameter = new ParameterDeclaration(DYNAMIC_CONFIG_POLICY_PARAMETER_NAME);
    parameter.setDescription(DYNAMIC_CONFIG_POLICY_DESCRIPTION);
    parameter.setExpressionSupport(NOT_SUPPORTED);
    parameter.setRequired(false);
    parameter.setParameterRole(BEHAVIOUR);
    parameter.setType(new DynamicConfigPolicyTypeBuilder().buildDynamicConfigPolicyType(), false);
    ...
    parameter.setDslConfiguration(ParameterDslConfiguration.builder()
        ...
        .build());
    parameter.addModelProperty(new QNameModelProperty(MULE_DYNAMIC_CONFIG_POLICY_TYPE_QNAME));
